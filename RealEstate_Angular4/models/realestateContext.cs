...
namespace RealEstate_Angular4.models
{
    public partial class realestateContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySQL(@"server=easeewaste.crcy3axworup.us-west-2.rds.amazonaws.com;user id=EFUser;database=realestate;password=Citlali890Leo.;sslmode=none;port=3306;ConnectionReset=True;");
        }
